...
<div class="navbtns">
	...
	<table align="center">
	<tr>
	<th>Number</th><th>Ride_ID</th><th>From</th><th>To</th><th>Date</th><th>Time</th><th>Fare/Person</th><th>NOF Seat Booked</th><th>Status</th><th>Action</th></tr>
	<%	
		int lineNo = 1;
	...
	<td><a href='DelayRide.jsp?u=<%=search[i].getRideID()%>'>Delay</a>
	<a href='CancelRide.jsp?u=<%=search[i].getRideID()%>'>Cancel</a>
	</td></tr>
